...
import { BindPublicInteractions, PageShell, SeoHead } from './public/PublicComponents'
...
export default function App() {
  ...
  if (pathname.startsWith('/internal') && !isLocalHost(window.location.hostname)) {
    document.title = '404 | SANCTUM Protocol'
    document.getElementById('root')!.innerHTML = NotFoundPage()
    return
  }

  if (pathname.startsWith('/internal')) {
    document.title = 'Internal | SANCTUM Protocol'
