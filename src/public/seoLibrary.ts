...
const relatedLinks = [
  ...
  { label: 'Partner Framework', href: '/partner-framework', text: 'A public-safe bridge for designers, builders, and operators.' },
]
...
const hubDefinitions = [
  ...
  ['environmental-intelligence-for-buildings', 'Environmental Intelligence For Buildings', 'How public environmental intelligence applies to buildings, shared spaces, and operations.', 'Environmental Intelligence', 'healthy-home'],
  ...
  ['environmental-wellness', 'Environmental Wellness', 'A public-safe hub for wellness as environmental design guidance.', 'Environmental Intelligence', 'recovery-framework'],
  ...
  ['public-governance-boundary', 'Public Governance Boundary', 'A hub for public-safe language, claims, and content boundaries.', 'Governance and Safety', 'recovery-framework'],
  ['partner-framework', 'Partner Framework', 'A hub for designers, builders, and operators who need public-safe SANCTUM language.', 'Professional and Partner', 'healthy-home'],
...
export const seoEntries: SeoEntry[] = [
  ...
  entry('environmental-intelligence-and-wellbeing', 'Environmental Intelligence and Wellbeing', 'A public-safe article on wellbeing as a design conversation about visible environmental conditions.', 'Environmental Intelligence', 'Wellness operators and designers', 'articles', 'recovery-framework'),
  ...
  entry('vibroacoustic-design-explained', 'Vibroacoustic Design Explained', 'A public-safe explanation of vibration, resonance, low-frequency awareness, and room comfort.', 'Sound and Vibration', 'Architects and acoustic teams', 'articles', 'sound-field'),
  ...
  entry('environmental-intelligence-for-builders', 'Environmental Intelligence for Builders', 'A partner brief for builders using public environmental intelligence language.', 'Professional and Partner', 'Builders', 'briefs', 'healthy-home'),
  ...
  entry('partnering-with-sanctum-protocol', 'Partnering with SANCTUM Protocol', 'A public-safe partner article for designers, builders, operators, and aligned studios.', 'Professional and Partner', 'Partners', 'articles', 'environmental-layers'),
...
export const hubRoutes: PublicPage[] = hubDefinitions.map(([slug, title, description, category, diagram]) => ({
  ...
  diagram,
  updated,
  observe: ['Visible environmental conditions', 'Room purpose and daily rhythm', 'Public-safe design language'],
